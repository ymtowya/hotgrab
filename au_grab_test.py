...
# /html/body/div[1]/div[5]/div[5]/div/div[2]/div[4]/div/div/div/span/ul/li[1]/div/div[2]/div/div/div/div/div/div/div[2]/div/p[1]/span[2]
# /html/body/div[1]/div[5]/div[5]/div/div[2]/div[4]/div/div/div/span/ul/li[1]/div/div[1]/div/div[2]/div/div/span/ul/li[1]/h3/a
ROOT_XPATH = "/html/body/div[1]/div[5]/div[5]/div/div[2]/div[4]/div/div/div/span/ul"
...
class weiboHotLineSpider:
    ...
    def getContent(self):
        ...
        try:
            ...
            driver.get('http://www.audible.com/coming-soon?pageSize=30')
            ...
            if not (tmpHotlines == None):
                self.hotlines = tmpHotlines.find_elements(By.XPATH, ".//li[contains(@class,\"productListItem\")]")
            ...
            if len(self.hotlines) > 0:
                ...
                try:
                    ...
                    for hotline in self.hotlines:
                        if (index > 31):
                            break
                        divs = hotline.find_elements(By.XPATH, "./div/div[1]/div/div[2]/div/div/span/ul/li[1]/h3/a")
                        print(len(divs))
                        if (len(divs) > 0):
                            tmpRow = []
                            ...
                            tagDivs = hotline.find_elements(By.XPATH, "./div/div[2]/div/div/div/div/div/div/div[2]/div/p[1]/span[2]")
                            if (len(tagDivs) > 0):
                                tmpRow.append(tagDivs[0].text)
                                """
                                tagAs = tagDivs[0].find_elements(By.TAG_NAME, "a")
                                if (len(tagAs) > 0) :
                                    tmpRow.append(self.dealHotnessString(tagAs[0].text)) # 3 - Price
                                else:
                                    tmpRow.append("--")
                                """
                            else :
