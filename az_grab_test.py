...
ROOT_XPATH = "/html/body/div[1]/div[3]/div/div/div[1]/div/div/div[2]/div[1]/div[1]"
...
class weiboHotLineSpider:
    ...
    def getContent(self):
        ...
        try:
            ...
            driver.get('http://www.amazon.ca/gp/new-releases/books')
            ...
            if not (tmpHotlines == None):
                self.hotlines = tmpHotlines.find_elements(By.XPATH, ".//div[contains(@id,\"gridItemRoot\")]")
            ...
            if len(self.hotlines) > 0:
                ...
                try:
                    ...
                    for hotline in self.hotlines:
                        if (index > 21):
                            break
                        divs = hotline.find_elements(By.XPATH, "/div[0]/div[1]/div[0]/span")
                        print(len(divs))
                        if (len(divs) > 0):
                            tmpRow = []
                            ...
                            tagDivs = hotline.find_elements(By.XPATH, ".//span[contains(@class,\"a-color-price\")]")
                            if (len(tagDivs) > 0):
